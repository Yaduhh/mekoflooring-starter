<x-layouts.app :title="__('Tambah Door Type')">
    <div class="max-w-2xl mx-auto p-8 bg-white dark:bg-zinc-800 rounded-xl">
        <div class="flex items-center gap-3 mb-8">
            ...
            <h2 class="text-2xl font-bold text-gray-800 dark:text-white">Tambah Door Type</h2>
        </div>
        ...
        <form action="{{ route('admin.door-types.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name') }}"
                       ...
                       placeholder="Contoh: Classic Panel, Modern Minimalis"
                       required>
            </div>
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 mt-1">Foto representatif jenis pintu ini (jpg, png, webp)</p>
            ...
            <div>
                ...
                <textarea name="description" rows="4"
                          ...
                          placeholder="Deskripsi singkat jenis pintu ini...">{{ old('description') }}</textarea>
            </div>
