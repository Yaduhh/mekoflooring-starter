        ...
        <div class="grid grid-cols-12 gap-6">
            <div class="col-span-12 lg:col-span-5 space-y-6 flex flex-col justify-center max-sm:px-6">
                ...
                <p class="text-justify capitalize" data-aos="fade-up" data-aos-duration="1500">
                    ...
                    teknologi terkini dari Jerman.
                </p>

                <div class="py-6 flex gap-8">
                    <a href="https://www.instagram.com/wpcmegakomposit/" target="_blank" class="text-[#131010] dark:text-white hover:text-[#F0BB78] hover:scale-110 duration-150 transition-all hover:cursor-pointer" data-aos="fade-up" data-aos-duration="2000">
                    ...
                    <a href="https://www.tiktok.com/@wpc_mki" target="_blank" class="text-[#131010] dark:text-white hover:text-[#F0BB78] hover:scale-110 duration-150 transition-all hover:cursor-pointer" data-aos="fade-up" data-aos-duration="2200">
                    ...
                    <a href="https://megakomposit.com/" target="_blank" class="text-[#131010] dark:text-white hover:text-[#F0BB78] hover:scale-110 duration-150 transition-all hover:cursor-pointer" data-aos="fade-up" data-aos-duration="2500">    
                        <svg width="30" height="30" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M14.8461 11C14.6572 14.6569 13.3103 18.159 11 21C8.68972 18.159 7.34276 14.6569 7.15384 11C7.34276 7.34309 8.68972 3.841 11 1C13.3103 3.841 14.6572 7.34309 14.8461 11Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </a>
                    <a href="https://wa.me/+628119112416" target="_blank"
                         class="text-[#131010] dark:text-white hover:text-[#F0BB78] hover:scale-110 duration-150 transition-all hover:cursor-pointer" data-aos="fade-up" data-aos-duration="2500">
                ...
                <a href="#produk" class="px-6 py-3 rounded-full text-white bg-[#131010] dark:bg-[#543A14] w-fit text-sm" data-aos="fade-up" data-aos-duration="2200">
                    More Product
                </a>
            </div>
            ...
            <div class="col-span-12 lg:col-span-7 max-sm:px-6 max-sm:mt-6">
                <div class="flex flex-row justify-between lg:gap-8 gap-2">
                    ...
                    <div class="w-full" data-aos="fade-up" data-aos-duration="2500">
                        <img src="{{ asset('assets/img/hilightProduk2.jpg') }}" alt="logo" class="w-full h-auto" />
                    </div>
                </div>
            </div>
        </div>
