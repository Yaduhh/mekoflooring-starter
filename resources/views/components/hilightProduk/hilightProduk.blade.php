<section id="hilight">
    <div class="w-full mx-auto lg:xl:max-w-6xl 2xl:max-w-7xl flex flex-col gap-10 lg:py-14 py-6">
                ...
                <div class="py-6 flex gap-8">
                    ...
                    <a href="https://megakomposit.com/" target="_blank" aria-label="Kunjungi Website Utama Kami"
                        ...
                        <svg width="30" height="30" viewBox="0 0 22 22" fill="none"
                            ...
                            <path
                                d="M14.8461 11C14.6572 14.6569 13.3103 18.159 11 21C8.68972 18.159 7.34276 14.6569 7.15384 11C7.34276 7.34309 8.68972 3.841 11 1C13.3103 3.841 14.6572 7.34309 14.8461 11Z"
                                stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                    </a>
