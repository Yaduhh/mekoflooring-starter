<section id="home" class="w-full flex items-center justify-center h-screen relative z-0 overflow-hidden">
    ...
    <div class="w-full mx-auto xl:max-w-7xl flex flex-col justify-center gap-10 max-lg:text-center max-sm:pt-10">
        ...
        <a href="https://wa.me/628119112416" target="_blank" data-aos="fade-up" data-aos-duration="1600"
            class="bg-white max-lg:mx-auto px-8 py-4 rounded-full w-fit text-[#131010] flex items-center gap-2 font-semibold hover:scale-110 duration-150 transition-all hover:cursor-pointer">
