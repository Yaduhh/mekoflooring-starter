<section id="home"
    class="w-full flex items-center lg:items-center justify-center min-h-screen relative z-0 overflow-hidden max-sm:py-20">
    ...
    <div
        class="mx-auto xl:xl:max-w-6xl 2xl:max-w-7xl flex flex-col lg:flex-row justify-center items-center h-full max-sm:pt-10">
        <div class="w-full flex flex-col justify-center h-full gap-10 :text-center">
            <div>
                <p class="font-medium text-white text-xl text-center pt-10" data-aos="fade-up" data-aos-duration="1200">
                    {{ __('Create Your Own Door Model With') }}
                </p>
                <div class="mx-auto max-w-xl mt-4 max-sm:px-6">
                    <img src="{{ asset('assets/img/textMegaDoor.png') }}" alt="logo"
                        class="w-full h-auto max-lg:object-cover">
                </div>
            </div>

            <div class="space-y-4 text-white" data-aos="fade-up" data-aos-duration="500">
                <div class="flex items-center justify-center gap-4">
                    {{--<div class="w-fit px-4 py-2 bg-gradient-to-r from-[#543A14] to-[#6B4E1A] text-white text-sm font-semibold rounded-full shadow-lg"
                        data-aos="fade-up" data-aos-duration="800">
                        ✨ Premium Quality Doors
                    </div>--}}
                    <div class="flex flex-row items-center gap-4 text-white">
                        <p class="text-center">Supported <span class="font-bold">By</span></p>
                        <div class="w-20 lg:w-32 pb-1 mx-auto">
                            <img src="{{ asset('assets/img/dekson.png') }}" alt="logo"
                                class="w-full h-auto max-lg:object-cover" />
                        </div>
                    </div>
                </div>
                ...
                <form id="wa-form" target="_blank">
                    <div class="bg-white dark:bg-[#131010]/30 backdrop-blur flex items-center rounded-2xl border border-white overflow-hidden">
                        <input id="wa-input" name="text"
                            class="w-full px-6 rounded-l-2xl text-black focus:border-none focus:outline-0"
                            placeholder="Mau nanya apa nih?" required />

                        <button type="submit"
                            class="bg-[#543A14] dark:bg-[#131010] text-white px-4 lg:px-8 py-2 max-sm:pt-3 lg:py-2.5 rounded-r-2xl w-fit flex items-center gap-2 font-semibold hover:scale-110 duration-150 transition-all hover:cursor-pointer">
            ...
            <div class="text-white mx-auto" data-aos="fade-up" data-aos-duration="1600">
                <p class="mb-2 font-semibold text-center">Follow Us</p>
                <div class="flex mx-auto justify-center items-center gap-10" data-aos="fade-up" data-aos-duration="1600">
                    <svg class="w-10 hover:fill-white hover:scale-125 duration-200 hover:cursor-pointer"
                    ...
                    <svg class="w-10 hover:fill-white hover:scale-125 duration-200 hover:cursor-pointer h-10"
            ...
            <a href="https://megakomposit.com" target="_blank"
                ...
                <p class="font-light max-sm:text-sm max-sm:text-left text-white">Part Of Mega<br />Komposit Indonesia</p>
            </a>
        </div>
    </div>
</section>
