<section id="home"
    ...
    <div
        class="mx-auto xl:xl:max-w-6xl 2xl:max-w-7xl flex flex-col lg:flex-row justify-between items-center h-full max-sm:pt-10">
        <div class="w-full flex flex-col justify-center h-full gap-10 max-lg:text-center">
            <div>
                <h1 class="text-4xl 2xl:text-5xl font-bold text-[#131010]" data-aos="fade-up" data-aos-duration="1000">
                    {{ __('Mega Door') }}
                </h1>
                <p class="font-medium text-[#131010] text-lg" data-aos="fade-up" data-aos-duration="1200">
                    {{ __('Create Your Own Door Model') }}</p>
            </div>
            ...
            <div class="space-y-4"  data-aos="fade-up" data-aos-duration="500">
                <div class="flex items-center gap-2">
                    <p>Supported <span class="font-bold">By</span></p>
                    <div class="w-20 lg:w-20">
            ...
            <div class="" data-aos="fade-up" data-aos-duration="1600">
                ...
                <div class="flex max-sm:justify-center items-center gap-10" data-aos="fade-up" data-aos-duration="1600">
                    <svg class="w-10 hover:fill-white hover:scale-125 duration-200 hover:cursor-pointer" viewBox="0 0 20 20"
        ...
        {{-- COL 2 --}}
        <div
            class="w-[50%] h-full flex flex-col min-h-screen justify-between items-stretch max-sm:mx-auto max-sm:hidden">
