<section id="produk">
    <div class="w-full flex flex-col gap-6  mx-auto lg:xl:max-w-6xl 2xl:max-w-7xl pb-10" data-aos="fade-up"
                ...
                <ul class="splide__list">
                    @foreach ($productsSPC as $product)
                        <li class="splide__slide relative z-0 w-full min-h-[380px] overflow-hidden border border-neutral-200 dark:border-neutral-700 group" role="presentation">
                            ...
                            <p class="text-xs bg-[#131010] text-white rounded-xl px-3 py-1 absolute top-4 left-4">
                    ...
                    <ul class="splide__list">
                        @foreach ($productsVinyl as $product)
                            <li class="splide__slide relative z-0 w-full min-h-[380px] overflow-hidden border border-neutral-200 dark:border-neutral-700 group" role="presentation">
                                ...
                                <p class="text-xs bg-[#131010] text-white rounded-xl px-3 py-1 absolute top-4 right-4">
                                    {{ $product->category->name_category }}</p>
                            </li>
                        @endforeach
                    </ul>
