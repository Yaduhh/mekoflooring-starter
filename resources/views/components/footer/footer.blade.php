        ...
        <div class="w-full">
            <div class="flex justify-between w-full">
                ...
                <div class="flex gap-10 pt-12 text-xl font-semibold text-white">
                    ...
                    <a class="hover:text-[#F0BB78] hover:cursor-pointer">Product</a>
                    <a class="hover:text-[#F0BB78] hover:cursor-pointer">Longue</a>
                </div>
    
                <div class="pt-12 flex gap-8">
                    <a class="text-white hover:text-[#F0BB78] hover:scale-110 duration-150 transition-all hover:cursor-pointer">
            ...
            <div class="flex justify-end pt-6 text-end text-white">
                <div class="w-80">
                    ...
                    <p class="mt-2">Ruko Boulevard Tekno, Jl. Tekno Widya No.21 Blok B, Setu, Kec. Setu, Kota Tangerang Selatan, Banten 15314</p>
                </div>
            </div>
        </div>
    </div>
