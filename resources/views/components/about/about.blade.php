    ...
    <div class="w-full flex flex-col gap-6 mx-auto lg:xl:max-w-6xl 2xl:max-w-7xl my-20 max-lg:px-6">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 mt-10">
            <div class="col-span-1 lg:col-span-4">
                ...
                <a href="#" class="w-full hidden dark:flex">
                    <img src="{{ asset('assets/img/aboutDark.png') }}" alt="logo about" class="w-full" />
                </a>
            </div>
        ...
        <div class="w-full px-8 py-10 card-outer">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
                <div class="col-span-1 lg:col-span-4">
                    <a href="#" class="w-full">
                        <img src="{{ asset('public/assets/gif/spc.gif') }}" alt="cara pemasangan" class="w-full" style="border-radius: 0.75rem;" />
                    </a>
                </div>
                ...
                <div class="col-span-1 lg:col-span-8">
                    ...
                    <div class="flex flex-col gap-6">
                        <div class="card-list-wrapper">
                            <ol class="card-list">
                                <li>Pastikan lantai rata, bersih, dan kering</li>
                                <li>Pasang papan menggunakan sistem klik</li>
                                <li>Potong papan sesuai ukuran yang dibutuhkan</li>
                                <li>Lanjutkan hingga seluruh area selesai terpasang</li>
                            </ol>

                            <p class="text-justify text-pretty mt-7 card-text">
                                Dengan Click System, pemasangan SPC Meko Flooring jadi lebih cepat, praktis, dan mudah dilakukan tanpa proses rumit.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap gap-6 lg:gap-16 font-semibold italic lg:mt-6">
                        ...
                        <a href="https://www.tiktok.com/@wpc_mki" target="_blank"
                            class="text-[#543A14] dark:text-[#FDFDFC] hover:text-[#F0BB78] flex gap-2 hover:scale-110 duration-150 transition-all hover:cursor-pointer">
                            <svg width="25" height="28" viewBox="0 0 17 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path d="M13.4872 3.13333C12.7463 2.26614 12.3379 1.15267 12.338 0H8.98788V13.7778C8.96258 14.5235 8.6556 15.2301 8.13171 15.7483C7.60782 16.2666 6.90798 16.556 6.17985 16.5556C4.64031 16.5556 3.36097 15.2667 3.36097 13.6667C3.36097 11.7556 5.16071 10.3222 7.01467 10.9111V7.4C3.27424 6.88889 0 9.86667 0 13.6667C0 17.3667 2.99235 20 6.16901 20C9.57334 20 12.338 17.1667 12.338 13.6667V6.67778C13.6965 7.67761 15.3275 8.21405 17 8.21111V4.77778C17 4.77778 14.9617 4.87778 13.4872 3.13333Z" fill="currentColor"/>
                            </svg>
        ...
        <div class="w-full px-8 py-10 card-outer">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 gap-4">
                ...
                <div class="flex flex-col items-center justify-center gap-3 p-5 card-inner">
                    <img src="{{ asset('public/assets/icons/eco-friendly.png') }}" alt="Eco-Friendly" class="w-14 h-14 object-contain" />
                    <p class="text-sm font-medium text-center card-text">Eco-Friendly</p>
                </div>

                <div class="flex flex-col items-center justify-center gap-3 p-5 card-inner">
                    <img src="{{ asset('public/assets/icons/durable-stable.png') }}" alt="Durable & Stable" class="w-14 h-14 object-contain" />
                    <p class="text-sm font-medium text-center card-text">Durable &amp; Stable</p>
                </div>

                <div class="flex flex-col items-center justify-center gap-3 p-5 card-inner">
                    <img src="{{ asset('public/assets/icons/easy-maintenance.png') }}" alt="Easy Maintenance" class="w-14 h-14 object-contain" />
                    <p class="text-sm font-medium text-center card-text">Easy Maintenance</p>
                </div>

                <div class="flex flex-col items-center justify-center gap-3 p-5 card-inner">
                    <img src="{{ asset('public/assets/icons/easy-installation.png') }}" alt="Easy Installation" class="w-14 h-14 object-contain" />
                    <p class="text-sm font-medium text-center card-text">Easy Installation</p>
                </div>

                <div class="flex flex-col items-center justify-center gap-3 p-5 card-inner">
                    <img src="{{ asset('public/assets/icons/water-fire-resistant.png') }}" alt="Water/Fire Resistant" class="w-14 h-14 object-contain" />
                    <p class="text-sm font-medium text-center card-text">Water/ Fire Resistant</p>
                </div>

                <div class="flex flex-col items-center justify-center gap-3 p-5 card-inner">
                    <img src="{{ asset('public/assets/icons/affordable.png') }}" alt="Affordable" class="w-14 h-14 object-contain" />
                    <p class="text-sm font-medium text-center card-text">Affordable</p>
                </div>
        ...
        <div class="mt-6 mb-10 w-full">
            <iframe
                ...
                referrerpolicy="no-referrer-when-downgrade" title="Peta lokasi PT. Mega Komposit Indonesia">
            </iframe>
        </div>
    </div>
</section>
